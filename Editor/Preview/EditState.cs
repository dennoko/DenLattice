...
namespace Dennokoworks.DenLattice.Editor
{
    ...
    internal readonly struct EditState : IEquatable<EditState>
    {
        ...
        ///
        /// 収集の順序と対象の絞り込みは <see cref="DenLatticePreviewFilter.GatherEditsInto"/> と
        ...
        /// （セッション外の変更の検出）では含めない。
        /// </param>
        internal static void Collect(IReadOnlyList<DenLattice> components, Renderer target,
        ...
        /// </summary>
        internal static void AppendFrom(DenLattice component, Renderer target,
            List<EditState> destination, bool includeLive)
        {
        ...
        /// </summary>
        internal static void AppendFrom(DenLattice component, HashSet<Renderer> targets,
            List<EditState> destination, bool includeLive)
        {
            if (component == null) return;
