...
{
    internal static class DenLatticeLocalization
    {
        private const string PrefsKey = "Dennokoworks.DenLattice.Language";
        private const string ResourceFileName = "denlattice_localization";
        ...
        private static void EnsureLoaded()
        {
            ...
            {
                Debug.LogWarning($"[DenLattice] Failed to parse localization resource: {ex.Message}");
            }
        ...
        private static string LoadJsonText()
        {
            ...
            var knownAssetPath = "Assets/dennokoworks/DenLattice/Editor/Localization/denlattice_localization.json";
            ...
            try
            {
                var files = System.IO.Directory.GetFiles(Application.dataPath, "denlattice_localization.json", System.IO.SearchOption.AllDirectories);
